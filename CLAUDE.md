...
This command **requires** the project directory as an argument via `/Users/halim/Documents/oulipo-dashboard`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/app_spec.txt` and `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/initializer_prompt.md`

If `/Users/halim/Documents/oulipo-dashboard` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/halim/Documents/oulipo-dashboard/.autoforge/prompts/.spec_status.json`
